...
const installButtonDiv = document.getElementById('floatPWA');
...
window.addEventListener("beforeinstallprompt", e => {
    ...
    installButtonDiv.style.visibility = "visible";
...
function installApp() {
    ...
    deferredPrompt.userChoice.then(choiceResult => {
        if (choiceResult.outcome === "accepted") {
            ...
            installButtonDiv.style.visibility = "hidden";
        } else {
...
let Menu_Ar = {
    ...
    liens: [
        "Controller/controll-gallery.php",
